...
export default function ComingSoonPage() {
  ...
  return (
    <div
      className="relative min-h-screen w-full flex flex-col justify-between text-white overflow-hidden bg-zinc-950 font-sans"
      style={{
        backgroundImage: `linear-gradient(to bottom, rgba(15, 12, 10, 0.75), rgba(15, 12, 10, 0.9)), url(${bgUrl})`,
    ...
    >
      ...
      <header className="w-full max-w-7xl mx-auto px-6 pt-8 flex flex-col items-center z-10">
        <h1 className="font-sans font-black text-md tracking-[0.25em] text-zinc-100">
          DRADIX
        </h1>
      </header>

      <main className="flex-1 flex flex-col justify-center items-center text-center z-10 max-w-4xl mx-auto px-6">
