...
const commitData = [
  ...
  { month: "Feb", commits: 78 },
  { month: "Mar", commits: 55 },
  { month: "Apr", commits: 92 },
  { month: "May", commits: 88 },
...
const recentFeed = [
  ...
  {
    action: "Created repo",
    target: "ml-playground",
    time: "2d ago",
    color: "#f43f5e",
  },
  {
    action: "Released v1.2 of",
    target: "dradix",
    time: "3d ago",
    color: "#005c58",
  },
      ...
      <div className="flex items-center gap-1.5 mt-2 justify-end">
        ...
        {opacities.map((o, i) => (
          <div
            ...
            style={{ backgroundColor: "#005c58", opacity: o }}
          />
        ))}
          ...
          <div>
            ...
            <div className="space-y-2">
              {topRepos.map((r) => (
                <div
                  key={r.name}
                  className="flex items-center gap-3 bg-[#1c1c1c] rounded-xl px-4 py-3 hover:bg-[#222] transition-colors cursor-pointer group"
                >
                  <div
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[13px] font-bold text-white group-hover:text-white">
                      {r.name}
                    </p>
                    <p className="text-[10px] text-[#555]">
                      {r.lang} · Updated {r.updated}
                    </p>
                  </div>
            ...
            <div className="space-y-1.5">
              {languages.map((l) => (
                <div key={l.name} className="flex items-center gap-2.5">
                  ...
                  <p className="text-[11px] text-[#555] w-7 text-right">
                    {l.value}%
                  </p>
                </div>
              ))}
