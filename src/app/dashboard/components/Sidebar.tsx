    ...
    <div>
      ...
      >
        <span
          ...
          style={{
            backgroundColor: isChildActive ? item.accent + "22" : "#1c1c1c",
            color: isChildActive ? item.accent : "#666",
          }}
        >
          <item.icon className="w-3.5 h-3.5" />
        </span>
      ...
      <div
        ...
        style={{
          maxHeight: open ? `${(item.children?.length ?? 0) * 44}px` : "0px",
        }}
      >
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: childActive ? item.accent : "#444",
                  }}
                />
                {child.label}
              </Link>
...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-57.5 bg-[#0c0c0c] flex flex-col z-40">
      <div className="px-5 py-5">
        <div className="flex items-center gap-2.5">
          ...
          <span className="ml-auto text-[9px] font-semibold text-[#003c3a] bg-[#003c3a]/15 rounded-md px-2 py-0.5">
            BETA
          </span>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-2 space-y-0.5 overflow-y-auto scrollbar-none">
        ...
        <div className="pt-4">
          <p className="text-[10px] font-semibold text-[#444] uppercase tracking-widest px-3 mb-2">
            Other
          </p>
          <Link
          ...
          >
            ...
            Notifications
            <span className="ml-auto text-[9px] font-bold bg-[#f43f5e] text-white rounded-full w-4 h-4 flex items-center justify-center shrink-0">
              3
            </span>
          </Link>
          <Link
