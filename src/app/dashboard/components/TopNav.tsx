  ...
  return (
    <header className="h-14 bg-[#101010] flex items-center px-6 gap-4 sticky top-0 z-30">
      <div className="flex-1">
        ...
        <p className="text-[11px] text-[#555]">Your developer journey at a glance</p>
      </div>

      <div className={`relative flex items-center gap-2 bg-[#161616] rounded-xl px-3 py-2 transition-all duration-200 ${searchFocused ? "w-56" : "w-40"}`}>
        ...
        />
        <kbd className="text-[9px] text-[#444] bg-[#222] rounded px-1 shrink-0">⌘K</kbd>
      </div>
      ...
      <div className="flex items-center gap-2.5 pl-3">
        ...
        <div className="hidden sm:block">
          ...
          <p className="text-[10px] text-[#555] leading-none mt-0.5">Developer</p>
        </div>
      </div>
    </header>
  );
