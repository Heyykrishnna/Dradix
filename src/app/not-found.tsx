    ...
    <div className="relative min-h-screen w-full flex flex-col justify-between overflow-hidden bg-zinc-950 text-white font-sans selection:bg-zinc-800">
      ...
      <main className="relative z-20 w-full max-w-[1600px] mx-auto px-6 sm:px-12 md:px-16 pb-12 sm:pb-16 md:pb-20 pt-20 flex-1 flex flex-col justify-end items-start">
        ...
        >
          ...
          >
            The path you requested could not be located in our developer space.
            It may have been moved, renamed, or never existed in the repository.
          </motion.p>
          ...
          >
            <button
              onClick={() => router.back()}
              className="btn-candy bg-linear-to-b from-zinc-800 via-zinc-900 to-zinc-950 border border-zinc-700/60 text-white font-sans text-xs font-medium uppercase tracking-wider px-6 py-3.5 rounded-full transition-all backdrop-blur-md cursor-pointer flex items-center gap-2"
            >
