    ...
    <div className="relative min-h-screen flex flex-col justify-between text-white overflow-x-hidden font-sans">
      ...
      <header className="w-full max-w-7xl mx-auto px-6 h-24 flex items-center justify-between z-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/dashboard"
            className="border border-white/25 hover:border-white/50 bg-white/10 hover:bg-white/20 text-[#015451] font-medium text-xs sm:text-sm px-4 py-2 rounded-full transition-all backdrop-blur-md shadow-md active:scale-95 inline-flex items-center justify-center"
          >
            Get Started
          </Link>
        </div>
